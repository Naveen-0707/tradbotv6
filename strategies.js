// ═══════════════════════════════════════════════════════════════════════════
//  FCB BOT V6 — strategies.js (strategy engine rev 7.1)
...
// ─── PARTIAL SCORE HELPER (final bonuses applied once in analyzeStock) ────────
// eslint-disable-next-line no-unused-vars
function applyBonuses(rawScore, direction, volRatio, niftyDir) {
  return rawScore; // returns a partial score; analyzeStock adds shared bonuses later
}
